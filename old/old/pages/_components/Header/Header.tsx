    ...
    return (
        ...
        <nav className="relative mx-auto flex bg-gray-800 items-center justify-between px-4 sm:px-6" aria-label="Global">
            ...
            <div className="hidden md:flex space-x-10">
                ...
                <NavLink className="font-medium text-white hover:text-gray-300" to="/docs">Get started</NavLink>
                    <NavLink className="font-medium text-white hover:text-gray-300" to="/docs">Docs</NavLink>
                    <NavLink className="font-medium text-white hover:text-gray-300" to="/docs">Components</NavLink>
                    <NavLink className="font-medium text-white hover:text-gray-300" to="/pages">Pages</NavLink>    
                    <NavLink className="font-medium text-white hover:text-gray-300" to="/docs">Resources</NavLink>
                </div>
